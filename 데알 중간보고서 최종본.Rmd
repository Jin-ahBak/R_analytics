...
sjp.aov1(핵심_데이터$자살_data,핵심_데이터$data.factor,geom.size=1.5,wrap.labels =7,axis.lim =c(15,40),meansums=T,show.summary=T,show.p=F,title="진보성향에 따른 지역 자살율",axis.labels = c("낮다","중간","높다"))
```
